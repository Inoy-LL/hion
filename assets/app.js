...
(function() {
  var Element, Helper, Paper, PropsPanel, RaphaelAdapter, Scheme, WIN_COLORS, conf, elements, getRandonColor, handleFileSelect,
  ...
  this.element_panel_select = function(gid) {
    ...
    return $("#g" + gid + " > .elements").append(elements_);
  };

  $('.elements > .group').live('click', function() {
    return element_panel_select($(this).data('id'));
  });
