...
(function() {
    ...
    PropsPanel.prototype.setProps = function(props) {
      ...
      for (name in props) {
        ...
        if (name && name.substr(0, 2) !== "on" && name.substr(0, 2) !== "do") {
          ...
          $("#props").append("<div>                               <span style=\"vertical-align: top;\">" + name + "</span>                               <span class=\"value\">                               " + value_string + "                               </span>                               </div>");
          if (name === "Font") {
  ...
  $('#left_menu_min').toggle(function() {
    ...
    return $(this).animateRotate(0, 90).animate({
      left: "-=57",
      top: "+=120",
      opacity: "-=0.3"
    });
    ...
    return $(this).animateRotate(90, 0).animate({
      left: "+=57",
      top: "-=120",
      opacity: "+=0.3"
    });
  ...
  $('#right_menu_min').toggle(function() {
    $(this).animateRotate(0, -90).animate({
      right: "-=95",
      top: "+=120",
      opacity: "-=0.3"
    }, "slow", function() {
