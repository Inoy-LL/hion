...
return p}},function(){var b,d,g,e;if("circle"!==this.type){this.animate({"fill-opacity":0.5},300,">");this.lx||(this.oy=this.ox=this.ly=this.lx=0,this.pos=!0);if(this.el)for(e=this.el,d=0,g=e.length;d<g;d++)b=e[d],"path"===b.type&&(b.old_path=b.attr("path"));return I.prototype.setProps(a)}},function(){var b,a,c,e,d,h,k,m;if("circle"!==this.type&&(this.animate({"fill-opacity":0.25},500,">"),this.ox=this.lx,this.oy=this.ly,this.el)){k=this.el;m=[];d=0;for(h=k.length;d<h;d++)e=k[d],"path"===e.type&&
e.dot2?(e.attr("path"),b=e.dot1.getBBox(),a=e.dot2.getBBox(),c=1===e.dot1.dot_type||2===e.dot1.dot_type?2:1,m.push(e.attr("path",g.path(b.x+2.5,b.y+2.5,a.x+2.5,a.y+2.5,c)))):m.push(void 0);return m}});return b.click(function(){if("circle"!==this.type)return d.prototype.selected_element&&d.prototype.selected_element.attr("stroke","#555"),d.prototype.selected_element=this,this.attr({stroke:"yellow"})})};a.prototype.getDotPosition=function(b){return[b.attr("cx"),b.attr("cy")]};a.prototype.drawLink=function(b,
a,f,r,s,e,l){var h;h=g.color.events;"on"!==b.substr(0,2)&&"do"!==b.substr(0,2)?(h=g.color.vars,b=1):b=2;a=d.getPaper().path(g.path(a,f,r,s,b));g.color.random&&(h=w());a.attr({stroke:h,"stroke-width":g.size,fill:"none",opacity:g.opacity});a.toBack();a.hover(function(a){this.attr({"stroke-width":g.active_size});m.prototype.hover_dot_animate(this.dot1,"on");return m.prototype.hover_dot_animate(this.dot2,"on")},function(){this.attr({"stroke-width":g.size});m.prototype.hover_dot_animate(this.dot1,"off");
return m.prototype.hover_dot_animate(this.dot2,"off")});a.start_rid=e.element[0].id;e.element.push(a);l&&l.element.push(a);return a};a.prototype.hover_dot_animate=function(a,c){null==c&&(c="on");return"on"===c?a.attr({fill:"red",r:5}):a.attr({fill:a.default_color,r:2.5})};return a}());I=function(){function a(){}a.prototype.setProps=function(a){var c,f,d,g,e,l,h,k;$("#props").empty();k=[];for(e in a)c=a[e],e&&"on"!==e.substr(0,2)&&"do"!==e.substr(0,2)?(c.value&&'"'===c.value[0]&&(c.value=c.value.substr(1,
c.value.length-2)),"Null()"===c.value||void 0===c.value?c.value="":"Color"===e?c.value=parseInt(c.value)+16777201:"Icon"===c.name&&"[]"===c.value&&(c.value="[]"),d='<input type="text" value="'+c.value+'"/>',f="","Color"===e&&(c.value?(f=z[c.value].rgb,e=z[c.value].name):e=f="white",d='<select style="background-color: '+f+'"><option selected>'+e+"</option></select>"),"Font"===e&&(f={0:"",1:"checked"},h=c.value.substr(1,c.value.length-2).split(","),d=h[0],l=h[1],c=h[2],g=h[3],h=h[4],d='            <span class="font_name" style="font-family: '+
...
a=16777215*Math.random()<<0;a>g.min_random_color&&(a-=g.min_random_color);a="#"+a.toString(16);0!==a.length-1&&(a=a.substr(0,4));return a};d.load($("textarea#sha_viewer").val());$("#redraw").click(function(){d.clear();return d.load($("textarea#sha_viewer").val())});q=function(){function a(){}var b;b=null;a.get=function(){null==b&&(d.getPaper().setStart(),d.getPaper().rect(0,0,1,20,4).attr({fill:"khaki"}),d.getPaper().text(0,10,"").attr({fill:"black"}),b=d.getPaper().setFinish().toFront().hide());
return b};a.setText=function(a){this.text=a;this.get().attr("text",a);this.get().attr("width",6*a.length);return this.get().show()};a.move=function(a,b){this.get()[0].attr("x",a+10);this.get()[0].attr("y",b-10);this.get()[1].attr("x",a+10+3*this.text.length);return this.get()[1].attr("y",b-10+9)};a.hide=function(){return this.get().hide()};a.show=function(){return this.get().show()};return a}();document.getElementById("files").addEventListener("change",function(a){var b;a=a.target.files[0];if(-1===
a.name.indexOf(".sha"))return alert("\u042d\u0442\u043e \u043d\u0435 \u0441\u0445\u0435\u043c\u0430!"),0;b=new FileReader;b.onload=function(a){return function(a){document.getElementById("sha_viewer").innerHTML=a.target.result;clearAll();return drawAll()}}(a);return b.readAsText(a,"WINDOWS-1251")},!1);H=function(){function a(){}var b,c;b=[];c=0;a.create=function(){$.ajax({url:"delphi_utf/Elements.txt",dataType:"json"}).success(function(c){var d,g,e,l,h;g="";h=c.groups;e=0;for(l=h.length;e<l;e++)d=
h[e],""!==d[1]&&(g+='<div class="group" id="g'+d[0]+'" data-id="'+d[0]+'"><div class="name">'+d[2]+'</div><div class="elements"></div></div></div>');$(".elements").append(g);b=c.elements;return a.element_panel_select(1)});a.bind_events();return!0};a.element_panel_select=function(a){var d,g,e,l;$(".elements > .group > .elements > *").slideUp().empty();if(c===a)return c=-1,!1;g="";e=0;for(l=b.length;e<l;e++)d=b[e],d[3]===a&&(g+='<span class="el"><img data-name="'+d[1]+'" src="delphi/icon/'+d[1]+'.ico"/></span>');
$("#g"+a+" > .elements").append(g).hide().slideDown();return c=a};a.bind_events=function(){$(".elements > .group").live("click",function(){return a.element_panel_select($(this).data("id"))});return $(".elements img").live("click",function(){var a,b;a=Math.round(9E6*Math.random()+1E6);b=$(this).data("name");d.addElement(b,a,350,350,{});return!1})};return a}();$("#left_menu_min").toggle(function(){$("#left_menu").animate({left:"-=200px"});$("#conte").animate({left:"-=121px"});return $(this).animateRotate(0,
90).animate({left:"-=57",top:"+=120",opacity:"-=0.3"})},function(){$("#left_menu").animate({left:"+=200px"});$("#conte").animate({left:"+=121px"});return $(this).animateRotate(90,0).animate({left:"+=57",top:"-=120",opacity:"+=0.3"})});$("#right_menu_min").toggle(function(){$(this).animateRotate(0,-90).animate({right:"-=95",top:"+=120",opacity:"-=0.3"},"slow",function(){return $(this).animate({right:"+=50",width:"-=100"})});return $("#right_menu").animate({right:"-=250px"})},function(){return $(this).animate({width:"+=100"},
100,function(){$(this).animateRotate(-90,0).animate({right:"+=45",top:"-=120",opacity:"+=0.3"});return $("#right_menu").animate({right:"+=250px"})})});H.create();z={0:{rgb:"#000000",name:"clBlack"},128:{rgb:"#800000",name:"clMaroon"},255:{rgb:"#FF0000",name:"clRed"},32768:{rgb:"#008000",name:"clGreen"},32896:{rgb:"#808000",name:"clOlive"},65280:{rgb:"#00FF00",name:"clLime"},65535:{rgb:"#FFFF00",name:"clYellow"},8388608:{rgb:"#000080",name:"clNavy"},8388736:{rgb:"#800080",name:"clPurple"},8421376:{rgb:"#008080",
name:"clTeal"},8421504:{rgb:"#808080",name:"clGray"},10789024:{rgb:"#A0A0A4",name:"clMedGray"},12632256:{rgb:"#C0C0C0",name:"clSilver"},12639424:{rgb:"#C0DCC0",name:"clMoneyGreen"},15780518:{rgb:"#A6CAF0",name:"clSkyBlue"},15793151:{rgb:"#FFFBF0",name:"clCream"},16711680:{rgb:"#0000FF",name:"clBlue"},16711935:{rgb:"#FF00FF",name:"clFuchsia"},16776960:{rgb:"#00FFFF",name:"clAqua"},16777215:{rgb:"#FFFFFF",name:"clWhite"},"R,G,B":{name:"###"},"-16777206":{rgb:"#B4B4B4",name:"clActiveBorder"},"-16777214":{rgb:"#99B4D1",
name:"clActiveCaption"},"-16777204":{rgb:"#ABABAB",name:"clAppWorkSpace"},"-16777215":{rgb:"#000000",name:"clBackground"},"-16777201":{rgb:"#F0F0F0",name:"clBtnFace"},"-16777196":{rgb:"#FFFFFF",name:"clBtnHighlight"},"-16777200":{rgb:"#A0A0A0",name:"clBtnShadow"},"-16777198":{rgb:"#000000",name:"clBtnText"},"-16777207":{rgb:"#000000",name:"clCaptionText"},"-16777189":{rgb:"#B9D1EA",name:"clGradientActiveCaption"},"-16777188":{rgb:"#D7E4F2",name:"clGradientInactiveCaption"},"-16777199":{rgb:"#6D6D6D",
name:"clGrayText"},"-16777203":{rgb:"#3399FF",name:"clHighlight"},"-16777202":{rgb:"#FFFFFF",name:"clHighlightText"},"-16777190":{rgb:"#0066CC",name:"clHotLight"},"-16777205":{rgb:"#F4F7FC",name:"clInactiveBorder"},"-16777213":{rgb:"#BFCDDB",name:"clInactiveCaption"},"-16777197":{rgb:"#434E54",name:"clInactiveCaptionText"},"-16777192":{rgb:"#FFFFE1",name:"clInfoBk"},"-16777193":{rgb:"#000000",name:"clInfoText"},"-16777212":{rgb:"#F0F0F0",name:"clMenu"},"-16777186":{rgb:"#F0F0F0",name:"clMenuBar"},
"-16777187":{rgb:"#3399FF",name:"clMenuHighlight"},"-16777209":{rgb:"#000000",name:"clMenuText"},"-16777216":{rgb:"#C8C8C8",name:"clScrollBar"},"-16777195":{rgb:"#696969",name:"cl3DDkShadow"},"-16777194":{rgb:"#E3E3E3",name:"cl3DLight"},"-16777211":{rgb:"#FFFFFF",name:"clWindow"},"-16777210":{rgb:"#646464",name:"clWindowFrame"},"-16777208":{rgb:"#000000",name:"clWindowText"}};$.fn.animateRotate=function(a,b,c,d,g){return this.each(function(){var m=$(this);$({deg:a}).animate({deg:b},{duration:c,easing:d,
step:function(a){m.css({transform:"rotate("+a+"deg)"})},complete:g||$.noop})})};jQuery.fn.fontSelector=function(a){var b="Arial,Arial,Helvetica,sans-serif;Arial Black,Arial Black,Gadget,sans-serif;Comic Sans MS,Comic Sans MS,cursive;Courier New,Courier New,Courier,monospace;Georgia,Georgia,serif;Impact,Charcoal,sans-serif;Lucida Console,Monaco,monospace;Lucida Sans Unicode,Lucida Grande,sans-serif;Palatino Linotype,Book Antiqua,Palatino,serif;Tahoma,Geneva,sans-serif;Times New Roman,Times,serif;Trebuchet MS,Helvetica,sans-serif;Verdana,Geneva,sans-serif".split(";");
