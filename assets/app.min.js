...
b=e.dot1.getBBox(),a=e.dot2.getBBox(),c=1===e.dot1.dot_type||2===e.dot1.dot_type?2:1,m.push(e.attr("path",g.path(b.x+2.5,b.y+2.5,a.x+2.5,a.y+2.5,c)))):m.push(void 0);return m}});return b.click(function(){if("circle"!==this.type)return d.prototype.selected_element&&d.prototype.selected_element.attr("stroke","#555"),d.prototype.selected_element=this,this.attr({stroke:"yellow"})})};a.prototype.getDotPosition=function(b){return[b.attr("cx"),b.attr("cy")]};a.prototype.drawLink=function(b,a,f,r,s,e,l){var h;
h=g.color.events;"on"!==b.substr(0,2)&&"do"!==b.substr(0,2)?(h=g.color.vars,b=1):b=2;a=d.getPaper().path(g.path(a,f,r,s,b));g.color.random&&(h=w());a.attr({stroke:h,"stroke-width":g.size,fill:"none",opacity:g.opacity});a.toBack();a.hover(function(a){this.attr({"stroke-width":g.active_size});m.prototype.hover_dot_animate(this.dot1,"on");return m.prototype.hover_dot_animate(this.dot2,"on")},function(){this.attr({"stroke-width":g.size});m.prototype.hover_dot_animate(this.dot1,"off");return m.prototype.hover_dot_animate(this.dot2,
"off")});a.start_rid=e.element[0].id;e.element.push(a);l&&l.element.push(a);return a};a.prototype.hover_dot_animate=function(a,c){null==c&&(c="on");return"on"===c?a.attr({fill:"red",r:5}):a.attr({fill:a.default_color,r:2.5})};return a}());I=function(){function a(){}a.prototype.setProps=function(a){var c,f,d,g,e,l,h,k;$("#props").empty();k=[];for(e in a)c=a[e],e&&"on"!==e.substr(0,2)&&"do"!==e.substr(0,2)?(c.value&&'"'===c.value[0]&&(c.value=c.value.substr(1,c.value.length-2)),"Null()"===c.value||
