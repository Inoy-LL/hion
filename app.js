...
(function() {
  var Element, Helper, Sha, colors, conf, create_line, elements, handleFileSelect, paper;
  ...
  paper.canvas.onmousemove = function(e) {
    var path, start_x, start_y, stop_x, stop_y;
    if (create_line) {
      stop_x = e.layerX;
      stop_y = e.layerY;
      ...
      return create_line.attr('path', path);
    }
  };

  paper.canvas.onmousedown = function(e) {
    if (create_line && e.which === 3) {
      create_line.remove();
      create_line = false;
    }
    return false;
  ...
  Element = (function() {
    ...
    Element.prototype.draw_dots = function(params, property) {
      ...
      for (param in params) {
        ...
        dot.click(function(e) {
          var color, start_x, start_y, stop_x, stop_y, this_type;
          if (create_line) {
            this_type = this.dot_type;
            if ((create_line.dot_type === "on" && this_type !== "do") || (create_line.dot_type === "top" && this_type !== "bot") || (create_line.dot_type === "do" && this_type !== "on") || (create_line.dot_type === "bot" && this_type !== "top")) {
              return false;
            }
    ...
    Element.prototype.save = function() {
      ...
      start = function() {
        var color, e, el, name, path, path_num, prop, value_string, _i, _j, _len, _len1, _ref, _results;
        this.ox = 0;
        this.oy = 0;
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          ...
          if (prop.name.substr(0, 4) !== "link") {
            if (prop.name === "Data" && prop.value === "Null()") {
              prop.value = "";
            ...
            $("#props").append("<tr>           <td>" + prop.name + "</td>           <td class=\"value\">             " + value_string + "           </td>          </tr>");
            if (prop.name === "Font") {
