...
(function() {
  var Element, Element1, Helper, Paper, PropsPanel, RaphaelAdapter, Scheme, WIN_COLORS, conf, handleFileSelect,
  ...
  Element = (function() {
    ...
    function Element(name, id, x, y, params) {
      ...
      for (key in this.props) {
        ...
        dot = Paper.prototype.drawDot(color, border_color, x, y, key, prop.hint, this.element);
        this.dots.push(dot);
        i[type]++;
      }
  ...
  RaphaelAdapter = (function() {
    ...
    RaphaelAdapter.prototype.create = function() {
      ...
      paper.canvas.onmousemove = function(e) {
        var path, stop_x, stop_y;
        if (Scheme.create_line) {
          stop_x = e.layerX - 3;
          stop_y = e.layerY - 3;
          path = Scheme.create_line.attr('path');
          return Scheme.create_line.attr('path', conf.link.path(path[0][1], path[0][2], stop_x, stop_y));
        }
      };
      paper.canvas.onmousemove = function(e) {
    ...
    RaphaelAdapter.prototype.drawDot = function(color, border_color, x, y, prop_name, prop_hint, element) {
      var dot, hint;
  ...
  Element1 = (function() {
    ...
    Element1.prototype.draw_dots = function(params, property) {
      if (a) {
        dot.click(function(e) {
          var color, path, start_x, start_y, stop_x, stop_y, this_type;
          if (Scheme.create_line) {
            this_type = this.dot_type;
            if ((Scheme.create_line.dot_type === "on" && this_type !== "do") || (Scheme.create_line.dot_type === "top" && this_type !== "bot") || (Scheme.create_line.dot_type === "do" && this_type !== "on") || (Scheme.create_line.dot_type === "bot" && this_type !== "top")) {
              return false;
            }
          ...
          Scheme.create_line.element = this.el;
          if (this.dot_type !== "on" && this.dot_type !== "do") {
            color = conf.link.color.vars;
          }
          ...
          return Scheme.create_line.toFront();
        });
